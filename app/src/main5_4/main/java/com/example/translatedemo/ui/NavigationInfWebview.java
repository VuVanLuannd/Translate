...
public class NavigationInfWebview extends AppCompatActivity {
    ...
    View.OnClickListener onclik=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.imgBack:
                    finish();
//                    startActivity(new Intent(NavigationInfWebview.this,NavigationInformation.class));
//                    Log.d("textd","sdf");
            }
        }
    };
    private void intview() {
        webView=(WebView)findViewById(R.id.wbDistplay);
